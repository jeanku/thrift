...
namespace Jeanku\Thrift\Transport;

use Jeanku\Thrift\Exception\TTransportException;
use Jeanku\Thrift\Factory\TStringFuncFactory;
...
class TCurlClient extends TTransport
{
    ...
    {
        if (!self::$curlHandle) {
            register_shutdown_function(array('Jeanku\Thrift\\Transport\\TCurlClient', 'closeCurlHandle'));
